...
export default function Bookings() {
  ...
  const filteredBookings = useMemo(() => {
    ...
    return bookings.filter((booking) => {
      ...
      const facilityName = booking.facility?.facilityName || "";
      const location = booking.facility?.location || "";
      const status = booking.status || "";

      return (
        bookingId.toLowerCase().includes(value) ||
        memberName.toLowerCase().includes(value) ||
        memberEmail.toLowerCase().includes(value) ||
        facilityName.toLowerCase().includes(value) ||
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-500">
            Review, confirm and manage community facility bookings.
          </p>
        </div>
